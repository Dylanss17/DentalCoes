...
<body class="bg-default">
      ...
      <div class="row align-items-center justify-content-xl-between">
        ...
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            ...
            <li class="nav-item">
              <a href="{{ url('index') }}" class="nav-link" target="_blank">Pagina web</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <!-- Argon Scripts -->
  <!-- Core -->
  <script src="{{ asset('vendor/jquery/dist/jquery.min.js') }}{{ asset('vendor/jquery/dist/jquery.min.js') }}"></script>
